...
function sm = oup_modulation(setup)
    ...
    DurationInPeriods     = (setup.L*setup.Fs)*(setup.tacsFreq./setup.Fs);     
    ...
    E               = normrnd(0,sigma,1,DurationInPeriods+1);
    ...
    sm              = interp1(0:DurationInPeriods,X,[(setup.tacsFreq./setup.Fs):(setup.tacsFreq./setup.Fs):DurationInPeriods]);
